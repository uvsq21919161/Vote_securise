...
function App() {
  ...
  const membres = [
    ...
    { nom: "Théo FRATCZAK", role: "Détenteur d’un fragment de clé" },    { nom: "Clémence DUMOULIN", role: "Détenteur d’un fragment de clé" },
    { nom: "Alexandre MIHET", role: "Détenteur d’un fragment de clé" },
    { nom: "Théo FRATCZAK", role: "Détenteur d’un fragment de clé" },    { nom: "Clémence DUMOULIN", role: "Détenteur d’un fragment de clé" },
    { nom: "Alexandre MIHET", role: "Détenteur d’un fragment de clé" },
    { nom: "Théo FRATCZAK", role: "Détenteur d’un fragment de clé" },    { nom: "Clémence DUMOULIN", role: "Détenteur d’un fragment de clé" },
    ...
    <div className="App">
      <div className="All">
        ...
        <div className="Container">
          ...
          <div className="BigRect">
            {" "}
            {/* Rectangle principal */}
            <img src={"/CercleDeco.png"} className="Deco " alt="deco" />
            ...
            <div className="Features">
              ...
              >
                <img src="/Icon/recepisse.png" alt="Icon 1" />
                Récépissé de vote
              </p>
              <p
                className="TexteFeatures"
              ...
              >
                <img src="/Icon/group.png" alt="Icon 4" />
            ...
            <div className="buttonContainer">
              ...
              <button
                ...
                onClick={() => setRes(true)}
              >
                <img src="/Icon/Res.png" alt="Icon Res" />
                Résultats
              </button>
            </div>
          </div>
        ...
        <div className="overlay">
          <div className="popup">
            <div className="headRes">
              <img src="/Icon/recepisse.png" alt="Icon Res" />
              <p>Résultats</p>
      ...
      {showUrne && (
        <div className="overlay">
          <div className="popup">
            <div class="headRes">
              <img src="/Icon/urne.png" alt="Icon urne" />
            ...
            <div class="borderRes">
              <div class="urneTitre">
                <img src="/Icon/Icon_vote.png" alt="Icon vote" />
                <p>
      ...
      {showMembreBureau && (
        <div className="overlay">
          <div className="popup">
            <div class="headRes">
              <img src="/Icon/group.png" alt="Icon Membre" />
              <p>
      ...
      {showRecepisse && (
        <div className="overlay">
          <div className="popup">
            <div class="headRes">
              <img src="/Icon/recepisse.png" alt="Icon urne" />
